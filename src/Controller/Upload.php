...
use Gm\Backend\Marketplace\ExtensionManager\Widget\UploadWindow;

/**
 * Контроллер загрузки файла пакета расширения модуля.
 * 
...
class Upload extends FormController
{
    ...
    public function perfomAction(): Response
    {
        ...
        /** @var \Gm\Backend\Marketplace\ExtensionManager\Model\UploadForm $form */
