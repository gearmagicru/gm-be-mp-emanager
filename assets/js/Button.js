...
Ext.define('Gm.be.mp.emanager.ButtonInstall', {
    ...
    listeners: {
        ...
        click: function (me, e, eOpts) {
            ...
            Gm.app.widget.load('@backend/marketplace/emanager/install/view', {installId: row.installId});
        }
    }
});
 ...
 */
 Ext.define('Gm.be.mp.emanager.ButtonUninstall', {
    extend: 'Gm.view.grid.button.Button',
    ...
    listeners: {
         ...
         */
         click: function (me, e, eOpts) {
            let row = me.selectorCmp.getStore().getOneSelected();
            // row.install = 'path,namespace'
            Gm.app.widget.load('@backend/marketplace/emanager/extension/delete', {installId: row.installId});
        }
    }
});
